...
var Auditors = [
	...
	{ value: "Bernard Dupuis" },
	{ value: "Georges Dupont" },
	{ value: "Michael Flanagan" },
	{ value: "David Essayan" },
	{ value: "Victorien Leleu" },
	{ value: "Gandhi" },
];
    ...
    init_mission_overlay: function(){
        ...
        $('#wmw-form-ob-4 input[type=checkbox]').on('change', function(){
            ...
            if($(this).is(':checked')){
				...
				Master.addExpShapForm($(this).val());
        ...
        $('.wmw-onboard-switches-el-label').on('click', function(e){
            e.preventDefault();
