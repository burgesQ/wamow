<?php include "../inc/header.inc.php"; ?>
		...
		<div class="wmw-dashboard col-xs-10 col-xs-offset-1 row">
			...
			<div class="wmw-dashboard-main col-xs-12 col-lg-10">
						...
						<div class="wmw-slider-element wmw-slider-element--special col-xs-12 col-sm-6 col-md-4">
							<div class="main-slider-element">
								<div class="main-slider-nopitch">
									No other pitch yet
									<small>Other pitch will be available soon</small>
								</div>
								<div class="main-slider-advice">
									<strong>Advice :</strong> You are more likely to be selected...Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.
								</div>
							</div>
						</div>
				...
				<h2 class="main-title"><i class="icon icon--document"></i>My missions</h2>
				...
				<div class="main-missions">
						...
						<div class="main-missions-el-infos col-xs-12 col-md-3 row">
							...
							<span class="infos-el infos-el--status col-xs-6">
								<span>
									...
									<span class="status">Interested</span>
								</span>
							</span>
							<span class="infos-el col-xs-6">
								<span>
									<i class="icon icon--calendar"></i><br />June 10<br />to July 25
								</span>
							</span>
							<span class="infos-el col-xs-6">
								<span>
									<i class="icon icon--pointer"></i><br />New York<br />USA
								</span>
							</span>
						</div>
					</div>
					...
					<div class="main-missions-el main-missions-el--waiting row">
						...
						<div class="main-missions-el-infos col-xs-12 col-md-3 row">
							...
							<span class="infos-el col-xs-6">
								<span>
									<i class="icon icon--star"></i><br />Shortlisted
									<a href="#">Up your proposal</a>
								</span>
							</span>
						</div>
					</div>
					...
					<div class="main-missions-el main-missions-el--closed row">
						<div class="main-missions-el-content col-xs-12 col-md-10">
							...
							<div class="content-links">
								<a href="#" class="content-showmore wmw-tinylink">
									<i class="icon icon--eye"></i> show more
								</a>
								<a href="#" class="content-delete wmw-tinylink">
									<i class="icon icon--trashbin"></i> Delete
								</a>
