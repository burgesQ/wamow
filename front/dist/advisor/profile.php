						...
						<form action="/" method="post" class="row">
							...
							<div class="col-xs-12 col-sm-5 row">
								<div class="wmw-bgfield col-xs-10">
									...
									<input type="email" id="profile-email" name="profile-email" value="michaelflanagan@gmail.com" class="required" disabled="true" />
									<div class="wmw-bgfield-bg"><i class="icon icon--email"></i></div>
								</div>
								<div class="col-xs-1">
									<div class="wmw-switchfield">
										<input type="checkbox" id="profile-notifications" name="profile-notifications" disabled="true" />
										<label for="profile-notifications"></label>
									</div>
								</div>
								<div class="wmw-bgfield col-xs-10">
									<label for="profile-backup-email">Backup email</label>
									<input type="email" id="profile-backup-email" name="profile-backup-email" value="michaelflanagan@gmail.com" class="required" disabled="true" />
									<div class="wmw-bgfield-bg"><i class="icon icon--email"></i></div>
								</div>							
							</div>
							...
							<div class="col-xs-12 col-sm-5 row">
								<div class="wmw-bgfield col-xs-10">
									...
									<input type="text" id="profile-phone" name="profile-phone" value="(415) 616-4906" class="required" disabled="true" />
							...
							<div class="col-xs-12 col-sm-5 col-sm-offset-2">
								<div class="wmw-bgfield">
									...
									<input type="text" id="profile-languages" name="profile-languages" value="US, FR, ESP" class="required" disabled="true" />
							...
							<div class="col-xs-12 col-sm-6">
								<div class="wmw-bgfield">
									...
									<input type="text" id="profile-address" name="profile-address" value="88 Kearny Street, Suite 600 - 94108 San Francisco" class="required" disabled="true" />
							...
							<div class="col-xs-12 col-sm-5 row">
								<div class="wmw-bgfield col-xs-10">
									...
									<input type="text" id="profile-company" name="profile-company" value="Accenture" class="required" disabled="true" />
							...
							<div class="col-xs-12 row">
								...
								<div class="col-xs-12 col-md-6 row">
									...
									<div class="wmw-bgfield col-xs-10">
										...
										<input type="text" id="profile-linkedin" name="profile-linkedin" value="http://linkedin.com/in/mickael-flanagan-53697a59" disabled="true" />
										<div class="wmw-bgfield-bg"><i class="icon icon--linkedin-thin"></i></div>
									</div>
									<div class="wmw-bgfield col-xs-10">
										<label for="profile-resume">Upload Resume</label>
										<input type="text" id="profile-resume" name="profile-resume" value="cv_mickael-flanagan_2017.pdf" disabled="true" />
										<div class="wmw-bgfield-file-hover">Change my resume</div>
										<input type="file" name="profile-resume-file" disabled="true" />
