<?php include "../inc/header.inc.php"; ?>
		...
		<form method="post" action="pitch-4.php" id="wmw-pitchprice-form" class="wmw-onboard wmw-onboard--pitch col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">

			<div class="wmw-onboard-body">

				<h1>
					Typologie de mission
					<small>Et concernant votre futur collaborateur ?</small>
				</h1>
				...
				<div class="wmw-onboard-price">
					...
					<div class="wmw-onboard-price-inner">
						...
						<div class="wmw-onboard-price-number">
							<span>12</span> consultants recevront votre pitch
						</div>
					</div>
				</div>
			...
			<div class="wmw-onboard-bottom">
				...
				<a href="pitch-2.php" class="wmw-button wmw-button--border"><i></i><span>Back</span><i></i></a>
