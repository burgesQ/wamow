module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        sass: {
            ...
            dist: {
                files: {
                    'dist/library/css/style.css': 'src/scss/style.scss',
                    'dist/library/css/print.css': 'src/scss/print.scss'
                }
            }
        },
        postcss: {
        ...
        uglify: {
            app: {
                files: {
                    'dist/library/js/scripts.min.js': [
        ...
        bsReload: {
            css: {
                reload: 'dist/library/css/style.css'
            },
            all: {
                reload: true
            }
